...
public class RedisTests {
    ...
    public void testSets() {
        ...
        redisTemplate.opsForSet().add(redisKey, "liubei", "zhangsan", "guanyu");
    ...
    public void testSortedSets() {
        ...
        redisTemplate.opsForZSet().add(redisKey, "sunwukong", 90);
    ...
    public void testTransactionl() {
        Object obj = redisTemplate.execute(new SessionCallback() {
            ...
            public Object execute(RedisOperations redisOperations) throws DataAccessException {
                ...
                System.out.println(redisOperations.opsForSet().members(redisKey)); //尝试在事务中查询
